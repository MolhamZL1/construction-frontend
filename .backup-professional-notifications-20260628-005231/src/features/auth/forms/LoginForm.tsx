...
import { registerAuthenticatedDevice } from '@/features/notifications/api/fcm.api'
...
export function LoginForm() {
  ...
  async function onSubmit(values: LoginSchema) {
    try {
      ...
      void registerAuthenticatedDevice({ requestPermission: true, forceSend: true }).catch(() => {
        // Login must not fail if browser notifications are blocked or FCM sync fails.
      })
