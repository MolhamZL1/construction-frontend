              ...
              <div className="min-w-0">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm font-medium text-slate-500">
                  ...
                  <button
                    ...
                    className="group inline-flex items-center gap-1.5 rounded-lg px-1.5 py-1 text-right transition hover:bg-[rgb(var(--color-brand-gold-rgb)/0.08)] hover:text-[var(--color-brand-ink)] disabled:cursor-default disabled:hover:bg-transparent disabled:hover:text-slate-500"
                  ...
                  >
                    ...
                    {onOwnerClick ? <ProjectDetailIcon name="edit" className="h-3.5 w-3.5 text-slate-400 opacity-0 transition group-hover:opacity-100" /> : null}
                  </button>
                </div>
              </div>
