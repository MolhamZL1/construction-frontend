...
export function useForegroundNotifications() {
  ...
  useEffect(() => {
    ...
    void listenToForegroundMessages((payload) => {
      ...
      // هذا الكرت الداخلي يظهر فقط لما التطبيق فاتح والـ JS شغال.
      setToasts((current) => [
        {
          id,
          title,
      ...
      // إذا الصفحة بالخلفية والرسالة وصلت للـ foreground handler، نعرض إشعار النظام أيضاً.
      // أما لو المتصفح مصغّر تماماً، firebase-messaging-sw.js يتولى إشعار النظام.
