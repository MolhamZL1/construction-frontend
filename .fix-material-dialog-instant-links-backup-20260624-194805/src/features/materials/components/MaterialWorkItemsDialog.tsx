...
export function MaterialWorkItemsDialog({
  ...
  useEffect(() => {
    if (selectedWorkItemName && linkedNames.includes(selectedWorkItemName)) {
      setSelectedWorkItemName('')
    }
  }, [linkedNames, selectedWorkItemName])
      ...
      <section className="w-full max-w-3xl overflow-hidden rounded-3xl bg-white text-right shadow-[0_24px_80px_rgba(15,23,42,0.28)]">
        ...
        <div className="space-y-6 p-6">
          <div className="rounded-3xl border border-slate-200 bg-white p-5">
            ...
            {isLoadingLinks ? <p className="mt-4 text-sm font-bold text-slate-500">جاري تحميل الارتباطات...</p> : null}
