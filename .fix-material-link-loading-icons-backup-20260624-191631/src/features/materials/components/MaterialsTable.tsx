...
function IconActionButton({ label, icon, tone = 'default', to, onClick }: IconActionButtonProps) {
  const className = tone === 'danger'
    ...
    : icon === 'link'
      ? 'inline-flex h-10 w-10 items-center justify-center rounded-xl border border-[#50683f]/20 bg-[#eef4eb] text-[#50683f] transition hover:border-[#50683f] hover:bg-[#dfead8]'
