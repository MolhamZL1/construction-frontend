  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] bg-white px-5 py-7 sm:px-8 lg:px-10" dir="rtl">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <header className="overflow-hidden rounded-3xl border border-emerald-100 bg-white text-right shadow-[0_12px_32px_rgba(15,23,42,0.07)]">
            ...
            <div className="mb-6 flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
              <div className="min-w-0 md:max-w-2xl">
                <div className="mb-3 flex flex-wrap items-center gap-2 text-sm font-bold text-slate-500">
                  ...
                  <Link
                    to={`/projects/${id}`}
                    className="max-w-[220px] truncate transition hover:text-[#50683f]"
                  >
                ...
                <div className="flex items-start justify-end gap-4">
                  ...
                  <div className="hidden h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#50683f]/10 text-[#50683f] sm:flex">
