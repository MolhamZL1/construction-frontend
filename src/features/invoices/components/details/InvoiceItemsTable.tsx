...
export function InvoiceItemsTable({ items, invoiceTotal }: InvoiceItemsTableProps) {
  ...
  return (
    <section className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_18px_55px_rgba(15,23,42,0.07)]">
      <div className="flex flex-col gap-3 border-b border-slate-100 bg-white px-5 py-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="rounded-full bg-[#f3f7f0] px-3 py-1 text-xs font-black text-[#50683f]">{formatInvoiceMoney(shownTotal)}</span>
        </div>
      </div>
            ...
            <table className="min-w-full text-right">
              ...
              <tfoot className="border-t border-slate-100 bg-slate-50">
                <tr>
                  ...
                  <td className="px-5 py-4 text-base font-black text-[#50683f]">{formatInvoiceMoney(shownTotal)}</td>
                  <td />
                </tr>
              </tfoot>
            </table>
