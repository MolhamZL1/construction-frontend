...
export function EditWorkItemPage() {
  ...
  return (
    <section className="min-h-screen bg-white px-5 py-7 text-right sm:px-8 lg:px-10" dir="rtl">
      <div className="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_12px_32px_rgba(15,23,42,0.07)]">
        ...
        <Link to={`/projects/${projectId}/work-items`} className="mt-5 inline-flex h-11 items-center justify-center rounded-xl bg-[#50683f] px-5 text-sm font-extrabold text-white">
          العودة إلى الجدول
        </Link>
      </div>
    </section>
