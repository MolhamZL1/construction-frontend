...
import { ProjectAiVisualizationsPage } from '@/features/projects/pages/ProjectAiVisualizationsPage'
import { CreateProjectAiVisualizationPage } from '@/features/projects/pages/CreateProjectAiVisualizationPage'
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: '/projects/:id/ai-visualizations/create',
            element: <CreateProjectAiVisualizationPage />,
          },
          {
            path: '/projects/:id/ai-visualizations',
            element: <ProjectAiVisualizationsPage />,
          },
          {
